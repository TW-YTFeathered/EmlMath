...
partial class Core
{
    ...
    public static Complex Asin(Complex x) => Mul(Neg(I), Ln(Add(Mul(I, x), Sqrt(Sub(One, Mul(x, x))))));
    ...
    public static Complex Acos(Complex x) => Mul(Neg(I), Ln(Add(x, Sqrt(Sub(Mul(x, x), One)))));
    ...
    public static Complex Atan(Complex x) => Mul(Div(I, Two), Ln(Div(Add(I, x), Sub(I, x))));
}
