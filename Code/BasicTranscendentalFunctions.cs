...
partial class Core
{
    ...
    /// <remarks>
    /// The implementation uses Eml(1,1) - Eml(1,x) as a branchless approach to safely handle x=0 without generating NaN.
    /// </remarks>
    public static Complex Ln(Complex x) => Eml(One, One) - Eml(One, x); // Branchless singularity handling
}
